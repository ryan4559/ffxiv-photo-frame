(() => {
  ...
  const translations = {
    'zh-Hant': {
      ...
      aperture: '光圈', shutter: '快門', focal: '焦距', optional: '選填', useDefault: '使用預設',
    ...
    en: {
      ...
      aperture: 'Aperture', shutter: 'Shutter', focal: 'Focal length', optional: 'optional', useDefault: 'Use default',
    ...
    ja: {
      ...
      aperture: '絞り', shutter: 'シャッター', focal: '焦点距離', optional: '任意', useDefault: '初期値を使用',
